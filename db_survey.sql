...
(1, 1, 2, 'Sample Only', 4, '2024-05-10 14:46:07'),
(2, 1, 2, '[JNmhW],[zZpTE]', 2, '2024-05-10 14:46:07'),
(3, 1, 2, 'dAWTD', 1, '2024-05-10 14:46:07'),
...
(5, 1, 3, '[qCMGO],[JNmhW]', 2, '2024-05-10 15:59:43'),
(6, 1, 3, 'esNuP', 1, '2024-05-10 15:59:43');
...
(1, 'Admin', 'Admin', '', '+123456789', 'Sample address', 'admin@admin.com', 'admin123', 1, '2020-11-10 08:43:06'),
...
(5,'Riya','Goyal','','9876543212','Ghaziabad','riya@goel.com','riya123',2,'2024-03-04 12:41:18');
...
--
ALTER TABLE `answers`MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;


--
-- AUTO_INCREMENT for table `questions`
--
ALTER TABLE `questions`MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `survey_set`
--
ALTER TABLE `survey_set`MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
